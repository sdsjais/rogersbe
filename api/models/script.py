...
import openai
# openai.api_key = os.getenv("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")
...
print()
#question = input("Enter your question from the text above: ")
question = sys.argv[1]
...
#   prediction = ""
#   for context in res.Text:
#     prediction = prediction +" "+ answer_question(question, context)
#   return prediction
